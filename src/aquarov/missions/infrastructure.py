...
class InfrastructureInspectionMission(MissionBase):
    ...
    def structure_observations(self) -> list[dict[str, Any]]:
        """Return a copy of structure observations."""
    ...
    def coverage(self) -> list[dict[str, Any]]:
        """Return a copy of inspection coverage records."""
    ...
    def inspection_summary(self) -> dict[str, Any]:
        """Return a summary of the inspection."""
        return {
    ...
    def record_structure_observation(
        ...
        """Record an observation about an underwater structure."""
        ...
        self._structure_observations.append(dict(observation))
    ...
    def record_defect(
        ...
        self._defects.append(dict(defect))
    ...
    def record_coverage(
        ...
        self._coverage.append(dict(coverage))
    ...
    def record_inspection(
        ...
        self._inspection_records.append(dict(record))
    ...
    def execute(self) -> MissionResult:
        """Execute and complete the inspection mission."""
